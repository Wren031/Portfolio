...
export const PROJECTS: Project[] = [
  {
    ...
    features: ["Sales processing", "Inventory tracking", "Business reporting"],
    color: "#00ffe1",
    loc: "15k",
    commits: 156,
    image: inventoryImg,
  ...
  },
  {
    ...
    features: ["Match scheduling", "Real-time chat", "Tournament brackets"],
    color: "#ff2d78",
    loc: "6.8k",
    commits: 132,
    image: clansImg,
  ...
  },
  {
    ...
    features: ["Appointment booking", "Patient records", "Telehealth workflow"],
    color: "#a259ff",
    loc: "2.1k",
    commits: 54,
    image: dermaImg,
  ...
  },
  {
    ...
    features: ["Plan comparison", "Billing dashboard", "Network status"],
    color: "#ffd60a",
    loc: "1.4k",
    commits: 38,
    image: profiberImg,
  ...
  },
  {
    ...
    features: ["Kanban workflow", "Live collaboration", "Team workspaces"],
    color: "#00ffe1",
    loc: "8.3k",
    commits: 201,
    image: screenshotImg,
